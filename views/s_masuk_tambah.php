                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="date" name="tgl_masuk" class="form-control" id="inputEmail3" placeholder="Inputkan Tanggal Surat" required>
                            </div>
                        </div>
...
if($_POST){
    ...
    //buat sql
    $sql="INSERT INTO tb_suratmasuk VALUES ('','$no_surat','$asal_surat','$tglmasuk','$penerbit','$perihal')";
